...
import ProductScreen from '../Duckbroodrwayscrns/ProductScreen';
// libs
...
const Duckbroodrwastacck = () => {
  ...
  return (
    <>
      {!isLoading ? <Duckbroodrwayload /> : <Route isFatch={route} />}
    </>
  );
};
